...
peer chaincode invoke $ORDERER_ARGS -C mychannel -n $CCNAME $ORG1_ARGS $ORG2_ARGS -c '{"function":"pickupPackage","Args":["677e9dcf985c890d","2021-02-12 09:57:25","40.8077","-74.0692","{ \"uid\": \"677e9dcf985c890d\", \"sender\": \"John\", \"from\": { \"street\": \"E 16th St.\", \"postal-code\": \"11212\" }, \"recipient\": \"Jane\", \"to\": { \"street\": \"E Florence Ave\", \"postal-code\": \"90001\" }, \"content\": { \"product\": \"PfizerVaccine\", \"description\": \"COVID-19 vaccine\", \"producer\": \"Pfizer\", \"count\": 100, \"start-lot-number\": \"A00001X\", \"end-lot-number\": \"A00100X\"}}"]}'
